...
<?php if  ($_SESSION['ID'] == 1){ ?>	
	<section id="main"><!-- #main content and sidebar area -->
			<section id="content"><!-- #content -->
				<h2>Lista de usuarios con pagos pendientes</h2>		

<?php
$strSQL = "SELECT ID,nick FROM usuario where pago = '1'";
...
<TR>
   ...
   <TD><?php echo $objRS["ID"];?></a></TD><TD> <a href="./perfil_usuarioadmin.php?ID=<?php echo $objRS["ID"]; ?> "><?php echo $objRS["nick"];?></TD><TD> <a href="./pagoRealizadoAdmin.php?nick=<?php echo $objRS["nick"]; ?> "> Pagado!</TD>
</TR>
